<div x-data="{ sidebarOpen: false }" class="flex h-screen bg-gray-200">
    ...
    <div :class="sidebarOpen ? 'translate-x-0 ease-out' : '-translate-x-full ease-in'"
        ...
        <nav class="mt-10">
            <a href="{{ route('home') }}"
                class="flex items-center px-6 py-2 mt-4 {{ request()->routeIs('home') ? 'text-gray-100 bg-gray-700 bg-opacity-25' : 'text-gray-500 hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100' }} no-underline">
            ...
            <a href="{{ route('booking.create') }}"
                ...
                <span class="mx-3">Booking Car</span>
            </a>
